...
def box_iou2(a, b):
    ...
    return float(s_intsec)/(s_a + s_b -s_intsec + 1e-6)
...
def draw_box_label(img, bbox_cv2,idx, box_color=(0, 255, 255), show_label=True):
    '''
...
#        cv2.putText(img,text_y,(left,top-5), font, font_size, font_color, 1, cv2.LINE_AA)
        cv2.putText(img,idx,(left,top-15), font, font_size, font_color, 1, cv2.LINE_AA)
